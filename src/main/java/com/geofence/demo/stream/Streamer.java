...
import com.geofence.demo.entity.CustomSerDes;
import com.geofence.demo.utility.HaversineTransformerSupplier;
...
public class Streamer {
    ...
    public static void main(String[] args) {
        ...
        StreamProperties rtdStreamProperties = new StreamProperties();
        ...
        try {
            ...
            final Serde<VehiclePositionFeed> serdeBusPosition = new SpecificAvroSerde<>();
            serdeBusPosition.configure((Map) props, false);

//        // create key/value store for bus positions
            final StoreBuilder<KeyValueStore<String, VehiclePositionFeed>> busPositionStore = Stores.keyValueStoreBuilder(
...
//
        ...
        final KStream<String, VehiclePositionFeed> rtdBusPositionStream = builder.stream("rtd-bus-position",
                Consumed.with(Serdes.String(), CustomSerDes.VehicleSpeed()));



//
//        // calculate the speed using the Haversine transform
//        final KStream<String, VehicleSpeed> rtdBusPositionStreamEnriched =
...
//                    LOG.info("ENRICHED: "+busPositionSpeed.toString());
